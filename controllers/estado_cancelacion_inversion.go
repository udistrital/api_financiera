...
type EstadoCancelacionInversionController struct {
	beego.Controller
}

// URLMapping ...
func (c *EstadoCancelacionInversionController) URLMapping() {
...
func (c *EstadoCancelacionInversionController) Post() {
	...
	if err := json.Unmarshal(c.Ctx.Input.RequestBody, &v); err == nil {
		if _, err := models.AddEstadoCancelacionInversion(&v); err == nil {
