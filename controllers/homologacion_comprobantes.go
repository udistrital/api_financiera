...
type HomologacionComprobantesController struct {
	beego.Controller
}

// URLMapping ...
func (c *HomologacionComprobantesController) URLMapping() {
...
func (c *HomologacionComprobantesController) Post() {
	...
	if err := json.Unmarshal(c.Ctx.Input.RequestBody, &v); err == nil {
		if _, err := models.AddHomologacionComprobantes(&v); err == nil {
