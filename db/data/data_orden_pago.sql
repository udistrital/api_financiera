...
-- Planta
INSERT INTO financiera.sub_tipo_orden_pago (nombre, activo, descripcion, codigo_abreviacion, numero_orden, tipo_orden_pago) VALUES ('Planta Administrativa', true, 'Orden de pago para nominas de planta administrativa', 'OP-PLAN-ADMI', 2.1, 2);
INSERT INTO financiera.sub_tipo_orden_pago (nombre, activo, descripcion, codigo_abreviacion, numero_orden, tipo_orden_pago) VALUES ('Planta Docente', true, 'Orden de pago para nominas de nomina de Docentes', 'OP-PLAN-DOCE', 2.2, 2);
-- HC
INSERT INTO financiera.sub_tipo_orden_pago (nombre, activo, descripcion, codigo_abreviacion, numero_orden, tipo_orden_pago) VALUES ('Hora Catedra Salarios', true, 'Orden de pago para nominas de Hora Catedra Salarios', 'OP-HC-SALA', 3.1, 3);
INSERT INTO financiera.sub_tipo_orden_pago (nombre, activo, descripcion, codigo_abreviacion, numero_orden, tipo_orden_pago) VALUES ('Hora Catedra Honorarios', true, 'Orden de pago para nominas de Hora Catedra Honorarios', 'OP-HC-HONO', 3.2, 3);
--SS
INSERT INTO financiera.sub_tipo_orden_pago (nombre, activo, descripcion, codigo_abreviacion, numero_orden, tipo_orden_pago) VALUES ('Seguridad Social Planta Administrativa', true, 'Orden de pago para nominas de Seguridad Social planta administrativa', 'OP-SS-PLAN-ADMI', 4.1, 4);
INSERT INTO financiera.sub_tipo_orden_pago (nombre, activo, descripcion, codigo_abreviacion, numero_orden, tipo_orden_pago) VALUES ('Seguridad Social Planta Docente', true, 'Orden de pago para nominas de nomina de Seguridad Social Docentes', 'OP-SS-PLAN-DOCE', 4.2, 4);
INSERT INTO financiera.sub_tipo_orden_pago (nombre, activo, descripcion, codigo_abreviacion, numero_orden, tipo_orden_pago) VALUES ('Seguridad Social Hora Catedra Salarios', true, 'Orden de pago para nominas de Seguridad Social Hora Catedra Salarios', 'OP-SS-HC-SALA', 4.3, 4);
INSERT INTO financiera.sub_tipo_orden_pago (nombre, activo, descripcion, codigo_abreviacion, numero_orden, tipo_orden_pago) VALUES ('Seguridad Social Hora Catedra Honorarios', true, 'Orden de pago para nominas de Seguridad Social Hora Catedra Honorarios', 'OP-SS-HC-HONO', 4.4, 4);
